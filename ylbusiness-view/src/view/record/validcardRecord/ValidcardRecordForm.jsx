 ...
 */
class ValidcardRecordForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      valid: false,
...
const noop = () => { };
ValidcardRecordForm.defaultProps = {
...
ValidcardRecordForm = Form.create()(ValidcardRecordForm);
export default ValidcardRecordForm;
