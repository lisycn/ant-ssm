...
class ChangerateRecordManageForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      advSearchShow: false,
    ...
    return (
      <Form horizontal className='advanced-search-form'>
        <Row>
          ...
          <Col sm={12} md={6}>
            <FormItem label='通道标识' labelCol={{ span: 10 }} wrapperCol={{ span: 14 }}>
              <Input placeholder='请输入通道标识：' {...getFieldProps('channel')} />
            </FormItem>
          </Col>
          <Col sm={12} md={6}>
...
const noop = () => {};
// 定义组件标签的可配置属性
ChangerateRecordManageForm.defaultProps = {
  onSubmit: noop,
  onReset: noop,
};

ChangerateRecordManageForm = Form.create()(ChangerateRecordManageForm);
export default ChangerateRecordManageForm;
