 ...
 */
class CallbackRecordForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      valid: false,
...
const noop = () => { };
CallbackRecordForm.defaultProps = {
...
CallbackRecordForm = Form.create()(CallbackRecordForm);
export default CallbackRecordForm;
