 ...
 */
class DownloadkeysRecordForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      valid: false,
...
const noop = () => { };
DownloadkeysRecordForm.defaultProps = {
...
DownloadkeysRecordForm = Form.create()(DownloadkeysRecordForm);
export default DownloadkeysRecordForm;
