 ...
 */
class CodepayRecordForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      valid: false,
...
const noop = () => { };
CodepayRecordForm.defaultProps = {
...
CodepayRecordForm = Form.create()(CodepayRecordForm);
export default CodepayRecordForm;
