 ...
 */
class RegesitorRecordForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      valid: false,
...
const noop = () => { };
RegesitorRecordForm.defaultProps = {
...
RegesitorRecordForm = Form.create()(RegesitorRecordForm);
export default RegesitorRecordForm;
