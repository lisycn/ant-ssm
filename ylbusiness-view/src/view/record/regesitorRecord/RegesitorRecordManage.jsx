...
import RegesitorRecordManageForm from './RegesitorRecordManageForm';
import TdPageTable from '../../../component/TdPageTable';
import RegesitorRecordForm from './RegesitorRecordForm';
 ...
 */
class RegesitorRecordManage extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      advSearchShow: false,
    ...
    return (
      <div>
        <TdCard hideHead='true' shadow='true'>
          <RegesitorRecordManageForm onSubmit={this.handleFormSubmit.bind(this) } onReset={this.handleFormReset.bind(this) } />
          <p className='br' />
          <TdPageTable rowKey={record => record.regesitorid}
            rowSelectCallback={this.handlerRowSelect.bind(this) } scroll={{ x: 1200 }}
            url={ylagent.record.queryRegesitorRecord}
          ...
          >
            <RegesitorRecordForm formReset={this.state.formReset}
...
RegesitorRecordManage = Form.create()(RegesitorRecordManage);
export default RegesitorRecordManage;
