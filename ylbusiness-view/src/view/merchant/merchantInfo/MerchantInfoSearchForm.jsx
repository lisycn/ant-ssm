 ...
 * 商户基本信息查询【查询条件form组件】
 */
class MerchantInfoSearchForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      advSearchShow: false,
...
const noop = () => {};
// 定义组件标签的可配置属性
MerchantInfoSearchForm.defaultProps = {
  onSubmit: noop,
  onReset: noop,
};

MerchantInfoSearchForm = Form.create()(MerchantInfoSearchForm);
export default MerchantInfoSearchForm;
