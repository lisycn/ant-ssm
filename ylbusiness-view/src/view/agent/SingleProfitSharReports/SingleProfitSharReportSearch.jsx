...
class SingleProfitSharReportSearch extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      valid: false,
...
const noop = () => { };
// 定义组件标签的可配置属性
SingleProfitSharReportSearch.defaultProps = {
  onSubmit: noop,
  onReset: noop,
};

SingleProfitSharReportSearch = Form.create()(SingleProfitSharReportSearch);
export default SingleProfitSharReportSearch;
