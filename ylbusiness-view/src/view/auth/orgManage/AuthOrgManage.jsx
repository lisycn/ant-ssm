...
class AuthOrgManage extends React.Component {
    ...
    queryAllOrg(){
        let opt={
            url:ylagent.authOrg.queryOrgList,
            type:"POST",
            dataType:"json",
            data:{}
        };
    ...
    handlerEditBtnClick(curNode) {
        let opt = {
            url:ylagent.authOrg.selectByOrgId,
            data: {orgId:curNode}
        };
        let obj = this;
        callAjax(opt, function (result) {
