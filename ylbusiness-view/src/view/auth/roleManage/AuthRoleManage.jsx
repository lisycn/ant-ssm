...
class AuthRoleManage extends React.Component {
    ...
    handleShowRoleAssign(text, record, key) {
        ...
        let opt = {
            url: ylagent.authRole.assignRole,
    ...
    handleSubmitClick() {
        let opt = {
            url: ylagent.authRole.assignAuth,
            data: {
        ...
        if (this.state.tableSelectedRows.length ===1 ) {
            confirm({
                ...
                onOk() {
                    ...
                    let opt = {
                        url: ylagent.authRole.deleteRole,
    ...
    */
    ...
    handlerRecordSts(param) {
        ...
        confirm({
            ...
            onOk() {
                let opt = {
                    url: ylagent.authRole.enableRole,
                    data: {
            ...
            <TdCard hideHead="true" shadow="true">
                ...
                <div>
                    ...
                    <TdPageTable width="1320" rowKey={record => record.roleId} scroll={{ x: "true" }}
                        ...
                        url={ylagent.authRole.queryRoleList}
                        toolbar={toolbar}
