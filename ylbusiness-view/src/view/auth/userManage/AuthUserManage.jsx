...
class AuthUserManage extends React.Component {
    ...
    componentDidMount() {
        let opt={
            url:ylagent.authOrg.selectDropdownListTree,
            type:"POST",
            dataType:"json",
            data:{}
        };
    ...
    handleAssignModalOk() {
        ...
        let obj = this;
        let opt = {
            url: ylagent.authRole.assignUsrRole,
            data: {
        ...
        if (this.state.tableSelectedRows.length == 1) {
            confirm({
                ...
                onOk() {
                    ...
                    let opt = {
                        url: ylagent.authUsr.resetUsrPwd,
                        data: {
                            usrId: data.usrId
                        }
                    };
        ...
        if (this.state.tableSelectedRows.length === 1) {
            ...
            confirm({
                ...
                onOk() {
                    ...
                    let opt = {
                        url: ylagent.authUsr.deleteUser,
    ...
    */
    ...
    handlerRecordSts(param) {
        ...
        confirm({
            ...
            onOk() {
                let opt = {
                    url: ylagent.authUsr.enableUser,
            ...
            <div>
                <TdCard hideHead="true" shadow="true">
                    ...
                    <TdPageTable rowKey={record => record.usrId}
                        ...
                        url={ylagent.authUsr.queryUserList}
                        toolbar={toolbar}
